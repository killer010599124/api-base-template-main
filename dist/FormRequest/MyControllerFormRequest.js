...
exports.checkFormDataExample = checkFormDataExample;
/*
...
function checkFormDataExample(body) {
  const {
    myInput
  } = body || {};
  const ret = {
    data: {},
    // object to validated data
    errors: [] // errors
  };
  ...
  if (!myInput) {
    ret.errors.push({
      mss: 'My error message',
      // <<= Your error message (ES-es || EN-en)
